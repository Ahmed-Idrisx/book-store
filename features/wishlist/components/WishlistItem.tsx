...
const WishlistItem = ({ item, isRemoving, onDelete }: WishlistItemProps) => {
  ...
  return (
    <div className="grid grid-cols-1 items-center gap-4 rounded-lg bg-white p-5 shadow-sm lg:grid-cols-12">
      ...
      {/* Price */}
      <div className="lg:text-center text-xl font-bold text-neutral-900 lg:col-span-3">
      ...
      {/* Delete */}
      <div className="flex lg:justify-center lg:col-span-2">
        <button
          type="button"
          onClick={onDelete}
          disabled={isRemoving}
